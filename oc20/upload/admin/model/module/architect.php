...
class ModelModuleArchitect extends Model
{
    ...
    public function uninstall()
    {
        ...
        $paths = array(
            ARC_CATALOG . 'model/architect/*.php',
            ARC_CATALOG . 'controller/architect/*.php',
            ARC_CATALOG . 'controller/architect/event/*.php',
            ARC_CATALOG . 'view/theme/default/template/architect/*.tpl',
        );
