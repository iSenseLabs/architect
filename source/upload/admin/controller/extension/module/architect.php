...
class ControllerExtensionModuleArchitect extends Controller
{
    ...
    public function __construct($registry)
    {
        ...
        $this->arc['url_ocmod_refresh'] = $this->url->link('marketplace/modification/refresh', $this->arc['url_token'], true);
    ...
    {
        if ($this->config->get('module_architect_install')) {
            $navs[] = array(
                'id'       => 'menu-architect',
                'icon'     => 'hidden"></i>
    ...
    {
        if ($this->config->get('module_architect_install') && !empty($params['module_id'])) {
