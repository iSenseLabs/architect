<div class="tab-panel form-horizontal">
    ...
    <div class="form-group date-duration">
        ...
        <div class="col-sm-9">
            ...
            <div class="col-sm-4">
                <div class="input-group js-date">
                    <input type="text" id="date-end" name="unpublish" value="<?php echo $architect['setting']['unpublish'] ? date('Y-m-d', strtotime($architect['setting']['unpublish'])) : ''; ?>" data-date-format="YYYY-MM-DD" class="form-control" data-toggle="tooltip" title="<?php echo $i18n['text_unpublish']; ?>">
