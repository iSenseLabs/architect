...
<div id="content" class="arc-module">
  ...
  <div class="content-head">
    ...
    <div class="pull-right">
      <button type="button" form="form-architect" class="save-changes btn btn-primary arc-save"><?php echo $i18n['text_save']; ?></button>
      <a href="<?php echo $architect['url_extension']; ?>" class="btn btn-default"><?php echo $i18n['text_close']; ?></a>
    </div>
  </div> <!-- /.content-head -->

  <div class="content-body">
    <form id="form-architect" action="<?php echo $architect['url_save']; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="panel-auto">
          <div class="panel-content">
            ...
            <div class="tab-navigation form-inline">
              ...
              <div class="pull-right">
                <a class="arc-info" data-toggle="modal" data-target="#arc-info"><i class="fa fa-info-circle"></i></a>
              </div>
            </div>
  ...
  <div id="arc-info" class="modal fade arc-info-modal" tabindex="-1" role="dialog">
